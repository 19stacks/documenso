declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_INVITE?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_PENDING?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_REMINDER?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_COMPLETED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_REJECTED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_REJECTION_CONFIRMED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_CANCELLED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_DOCUMENT_DELETED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_RECIPIENT_SIGNED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_RECIPIENT_EXPIRED?: string;
    NEXT_PRIVATE_SENDGRID_TEMPLATE_RECIPIENT_REMOVED?: string;
