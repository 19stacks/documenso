...
# Pull the latest staging image, replace the running container, and clean up
# the old image. Run this on the staging server.
# Requires a .env.docker file in the same directory.

IMAGE="registry.gitlab.com/rl-onboard-crm/onboard-crm-documenso"
TAG="Staging"
CONTAINER_NAME="documenso-staging"
PORT="3020"
ENV_FILE=".env.docker"
...
info "Stopping old staging container (if any)"
...
ok "Done. Tailing staging logs (ctrl+c to stop watching, container keeps running):"
